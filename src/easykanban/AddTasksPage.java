 ...
 */
public class AddTasksPage extends javax.swing.JFrame {

    /**
     * Creates new form AddTasksPage
     */
    public AddTasksPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adding Tasks");

        jLabel2.setText("Enter Task Name");

        jLabel3.setText("Enter Task Description (max 50 characters)");

        jLabel4.setText("Enter Developer Details (Name and Surname)");

        jLabel5.setText("Enter Task Duration (in hours)");

        jLabel6.setText("Select Task Status");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddTasksPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddTasksPage().setVisible(true);
            }
        });
    }
